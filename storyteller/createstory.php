			...
			<div class="min-height-200px">
				...
				<!-- Default Basic Forms Start -->
                                   <div class="pd-20 card-box mb-30">
                                       <form action="post_story.php" method="post" enctype="multipart/form-data">
                                           <input type="hidden" name="todo" value="post">
                                                <div class="form-group">
							<label>Title</label>
							 <input type="text" class="form-control" placeholder="Maximum 20 Words" name="title">
                                                </div>
                                               <div class="form-group">
                ...
                <option value="Zimbabwe">Zimbabwe</option>
							...
							<label>Image</label>
							 <input type="file" class="form-control" placeholder="Select Image" name="ufile">
                                            ...
                                            <div class="form-group">
                                            <label>Message</label>
                                            <textarea class="form-control" rows="8" cols="125" name="message"placeholder="Write your story here"></textarea>
                                            </div>
